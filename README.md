...
2.5. [Системные](https://github.com/Kwoargus/Error-studies) — несовместимость используемых компонентов и возможностей операционной системы.
